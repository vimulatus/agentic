...
1. Read `<evidence-dir>/SKILL.md` for the Embed rules. Read every `findingsPath`. The hunter's table names the findings; the file holds the blocks and the evidence.
