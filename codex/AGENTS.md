...
- Every project AGENTS.md carries a `## Product` section: what it is, who uses it, its stage. And a `## Ship` section: how to run, gate and ship it. Read both before you plan.
