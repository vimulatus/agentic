...
Public copies live in [vimulatus/skills](https://github.com/vimulatus/skills). `bun run scripts/promote.ts <skill>` promotes one skill into that checkout, and its `scripts/release.sh` pushes `main`.
